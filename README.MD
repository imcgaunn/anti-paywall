...
This is exactly the same as the original 'anti-paywall' addon, but it has been run through
microsoft's 'edge extension toolkit' which installs shims that translate between edge and
chrome APIs.
